...
impl ModelManager {
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        if let Ok(config_path) = app_handle.path().resolve(
            "resources/models/models.json",
            tauri::path::BaseDirectory::Resource,
        ) {
            if config_path.exists() {
                match fs::read_to_string(&config_path) {
                    Ok(data) => match serde_json::from_str::<Vec<ModelConfig>>(&data) {
                        Ok(configs) => {
                            for cfg in configs {
                                available_models.insert(
                                    ...
                                    ModelInfo {
                                        ...
                                        speed_score: cfg.speed_score,
                                    },
                                );
                            }
                        }
                        Err(err) => {
                            warn!("Failed to parse models.json: {}", err);
                        }
                    },
                    Err(err) => {
                        warn!("Failed to read models.json: {}", err);
                    }
                }
            }
        }
        ...
        available_models
            ...
            .or_insert(ModelInfo {
                ...
                url: Some("https://huggingface.co/Vasista03/Nugget/resolve/main/ggml-small.bin"
                    .to_string()),
                size_mb: 487,
                is_downloaded: false,
                is_downloading: false,
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://huggingface.co/Vasista03/Nugget/resolve/main/whisper-medium-q4_1.bin
".to_string()),
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://huggingface.co/Vasista03/Nugget/resolve/main/ggml-large-v3-turbo.bin
".to_string()),
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://huggingface.co/Vasista03/Nugget/resolve/main/ggml-large-v3-q5_0.bin
".to_string()),
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://huggingface.co/Vasista03/Nugget/resolve/main/parakeet-v2-int8.tar.gz
".to_string()),
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://huggingface.co/Vasista03/Nugget/resolve/main/parakeet-v3-int8.tar.gz
".to_string()),
