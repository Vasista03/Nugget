...
pub enum AppTheme {
    Dark,
    Light,
    Colored, // Yellowish gold/colored theme for Linux
}
...
pub fn get_icon_path(theme: AppTheme, state: TrayIconState) -> &'static str {
    match (theme, state) {
        ...
        // Colored theme uses yellowish gold icons (for Linux)
        (AppTheme::Colored, TrayIconState::Idle) => "resources/nugget.png",
...
pub fn update_tray_menu(app: &AppHandle, state: &TrayIconState) {
    ...
    let version_label = format!("Nugget v{}", env!("CARGO_PKG_VERSION"));
