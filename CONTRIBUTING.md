...
Thank you for your interest in contributing to Nugget! This guide will help you get started with contributing to this open source speech-to-text application.

## 📖 Philosophy

Nugget aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Nugget.git
   cd Nugget
   ```
...
3. **Add upstream remote**:
   ...
   ```bash
   git remote add upstream git@github.com:Vasista03/Nugget.git
   ```
...
Nugget follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/Vasista03/Nugget/issues](https://github.com/Vasista03/Nugget/issues)
2. **Check discussions** at [github.com/Vasista03/Nugget/discussions](https://github.com/Vasista03/Nugget/discussions)
...
1. **Search existing discussions** at [github.com/Vasista03/Nugget/discussions](https://github.com/Vasista03/Nugget/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/Vasista03/Nugget/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/Vasista03/Nugget/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/Vasista03/Nugget/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with Nugget's philosophy
...
7. **Create a Pull Request**:
   - Go to the [Nugget repository](https://github.com/Vasista03/Nugget)
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/Vasista03/Nugget/discussions)

## 📜 License

By contributing to Nugget, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Nugget!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
